...
if( have_rows('attributes', 'option') ):
    ...
    while ( have_rows('attributes', 'option') ) : the_row();
        ...
        $attributes .= '<td class="text-center py-3"><img src="' . $safe_type['attribute_image'] . '"  class="attribute-icons text-secondary" /></td>';
        $attributes .= '<td class="pe-0"><p class="fw-bold mb-0 d-inline fs-5">' . $safe_type['attribute_label'] . ':</p></td>';
