...
<?php $count = 1; while (have_rows( 'models' )): the_row(); ?>
    ...
    <div class="single-safe-model">
        ...
        <div class="model-image-container">
           ...
           <?php  /*?> <a class="open-modal" href="#safe-<?php echo $count; ?>"><?php */?>
            <a class="detail-page-link" href="<?php echo add_query_arg( array('post' => $post->ID, 
  'model' => $count),
  site_url()."/safe-details"
			...
			<?php /*?><a href="<?php echo add_query_arg( 'post', 4,site_url()."/safe-details")?>">test</a><?php */?>
  ...
  'model' => $count),
  site_url()."/safe-details"
);?>"><span class="model-code"><?php the_sub_field( 'model_code' ); ?></span></a>
